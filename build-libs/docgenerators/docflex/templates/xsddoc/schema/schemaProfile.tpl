			...
			<CTRL_GROUP>
				...
				<CTRLS>
					<DATA_CTRL>
						...
						<URL_HLINK>
							COND='getAttrStringValue("targetNamespace") != ""'
							ALT_HLINK
							TARGET_FRAME_EXPR='"_blank"'
							URL_EXPR='getAttrStringValue("targetNamespace")'
						</URL_HLINK>
...
CHECKSUM='gvfU1AHm?AIaJK9snRNaiw'
</DOCFLEX_TEMPLATE>