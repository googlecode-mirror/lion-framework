...
DSM_TYPE_ID='xsddoc'
ROOT_ET='#DOCUMENTS'
DESCR='This template generates a single multi-framed hypertext documentation for any number of XML Schemas.\n<p>\n<b>Note:</b> The destination output format may be only HTML.'
...
<TEMPLATE_PARAMS>
	...
	PARAM={
		...
		param.description='Controls if the unprocessed XML tags should appear in the documentation as ordinary text.\n<p>\nWhen this parameter is <code><b>true</b></code> (checked), all XML tags (contained in the annotation) that have not been specifically processed (see <i>"Process XHTML tags"</i> parameter) will be shown in the generated documentation.\n<p>\nIf the parameter is <code><b>false</b></code> (unchecked), any unprocessed tags will be removed.\n<p>\nIn particular, if you have annotation preformatted with XHTML tags and want to show them only as a pure text extracted from them (without any formatting and any markup tags), you should set <code>false</code> both this and <i>"Process XHTML tags"</i> parameters.';
		param.type='boolean';
		param.boolean.default='true';
	}
	PARAM={
		...
		param.description='Controls whether to include images specified with the XHTML <code>&lt;img&gt;</code> tags.\n<p>\nThis parameter works in conjunction with the <i>"Process XHTML tags"</i> parameter, when processing of the embedded XHTML markup is enabled.\n<p>\nIf the parameter is <code><b>true</b></code> (checked), all <code>&lt;img&gt;</code> tags will be processed and the images specified in them inserted in the generated documentation.\n<p>\nWhen the parameter is <code><b>false</b></code> (unchecked), the <code>&lt;img&gt;</code> tags will be recognized still, however just passed over without particular processing.\n<p>\n<b>See Also:</b>\n<blockquote>\n<i>"Sections | Annotation | Process XHTML tags"</i><br>\n<i>"Sections | Annotation | Copy Images"</i>\n</blockquote>';
		param.type='boolean';
		param.boolean.default='true';
	}
	PARAM={
	...
	PARAM={
		...
		param.displayName='XML Source';
		param.description='This group of parameters controls the appearance and content of the reproduced XML source included in the documentation.';
		param.type='grouping';
	}
	PARAM={
	...
	PARAM={
		param.name='sec.xmlSource.remove.ann';
		param.displayName='Remove Annotations';
		param.description='This group of parameters controls if <b><code>&lt;xs:annotation&gt;</code></b> elements should be removed from the whole reproduced XML source or some its fragments.\n<p>\nYou may want to not show the <code>&lt;xs:annotation&gt;</code> elements particularly when you use XHTML tags to format your annotation texts. In that case, the full XML source of such elements may be so large that it will overwhelm anything else. (On other hand, the content of those elements will be already shown in the documentation as the formatted descriptions.)';
		param.type='grouping';
	}
	PARAM={
		param.name='sec.xmlSource.remove.ann.schema';
		param.displayName='Schemas';
		param.description='Specifies whether to remove all <code>&lt;xs:annotation&gt;</code> elements from the reproduced XML source of the whole schema.\n<p>\n<b>See Also:</b>\n<blockquote>\nParameter: <i>"Details | Schema Overview | XML Source"</i>\n</blockquote>';
		param.type='boolean';
	}
	PARAM={
		param.name='sec.xmlSource.remove.ann.component';
		param.displayName='Components';
		param.description='Specifies whether to remove all <code>&lt;xs:annotation&gt;</code> elements from the XML source of each schema component.\n<p>\n<b>See Also:</b>\n<blockquote>\nParameter: <i>"Details | Component Documentation | XML Source"</i>\n</blockquote>';
		param.type='boolean';
		param.boolean.default='true';
	}
	PARAM={
		...
		param.displayName='Attribute Detail';
		param.description='Specifies whether to remove all <code>&lt;xs:annotation&gt;</code> elements from the XML source of each <i>attribute definition</i>.\n<p>\n<b>See Also:</b>\n<blockquote>\nParameter: <i>"Sections | Attribute Detail | XML Source"</i>\n</blockquote>';
		param.type='boolean';
		param.boolean.default='true';
	}
	PARAM={
		param.name='sec.xmlSource.remove.ann.contentElements';
		param.displayName='Content Element Detail';
		param.description='Specifies whether to remove all <code>&lt;xs:annotation&gt;</code> elements from the XML source of each <i>content element definition</i>.\n<p>\n<b>See Also:</b>\n<blockquote>\nParameter: <i>"Sections | Content Element Detail | XML Source"</i>\n</blockquote>';
		param.type='boolean';
		param.boolean.default='true';
	}
	PARAM={
...
<FRAMESET>
	...
	<FRAMESET>
		...
		<FRAME>
			PERCENT_SIZE=70
			NAME='listFrame'
			SOURCE_EXPR='documentByTemplate("overview-summary;namespace-summary") != null\n? documentByTemplate ("namespace-frame;schema-frame")\n: documentByTemplate ("schema-frame")'
		</FRAME>
	</FRAMESET>
	<FRAME>
		PERCENT_SIZE=80
...
<ROOT>
	...
	<ELEMENT_ITER>
		...
		<BODY>
			<TEMPLATE_CALL>
				COND='iterator.numItems > 1 || getBooleanParam("include.detail.namespace")'
	...
	<TEMPLATE_CALL>
		...
		TEMPLATE_FILE='xsddoc/xml/xmlns-bindings.tpl'
		OUTPUT_TYPE='document'
...
CHECKSUM='g1udd5cND+7U0QE0Tf0F0g'
</DOCFLEX_TEMPLATE>