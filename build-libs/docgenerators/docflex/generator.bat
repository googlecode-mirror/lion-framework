...
::----------------------------------------------------------------------
set JRE="C:\Program Files\Java\jre1.6.0_02"
...
::----------------------------------------------------------------------
set JAVA_OPTIONS=%JAVA_OPTIONS% -cp %DFH%\lib\xml-apis.jar;%DFH%\lib\xercesImpl.jar;%DFH%\lib\docflex-xml-kit.jar

::----------------------------------------------------------------------
:: Running generator with all settings taken from generator.config file
::----------------------------------------------------------------------
%JRE%\bin\java %JAVA_OPTIONS% com.docflex.xml.Generator -config generator.config -nodialog