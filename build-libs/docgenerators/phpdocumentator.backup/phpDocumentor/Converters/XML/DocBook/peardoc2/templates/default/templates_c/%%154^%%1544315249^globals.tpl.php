<?php /* Smarty version 2.6.0, created on 2004-01-18 23:09:17
         compiled from globals.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'globals.tpl', 17, false),)), $this); ?>
...
$this->_sections['files']['loop'] = is_array($_loop=$this->_tpl_vars['globals']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['d']['loop'] = is_array($_loop=$this->_tpl_vars['globals'][$this->_sections['files']['index']]['globals']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<?php if ($this->_tpl_vars['globals'][$this->_sections['files']['index']]['globals'][$this->_sections['d']['index']]['conflicts']):  echo smarty_function_assign(array('var' => 'globalconflict','value' => true), $this); endif; ?>
<?php endfor; endif; ?>
...
<?php if (isset($this->_sections['d'])) unset($this->_sections['d']);
$this->_sections['d']['name'] = 'd';
$this->_sections['d']['loop'] = is_array($_loop=$this->_tpl_vars['globals']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['d']['show'] = true;
$this->_sections['d']['max'] = $this->_sections['d']['loop'];
$this->_sections['d']['step'] = 1;
$this->_sections['d']['start'] = $this->_sections['d']['step'] > 0 ? 0 : $this->_sections['d']['loop']-1;
