...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'class_summary.tpl', 8, false),)), $this); ?>
...
<refsect1>
 ...
 <?php echo ((is_array($_tmp=@$this->_tpl_vars['desc'])) ? $this->_run_mod_handler('default', true, $_tmp, "&notdocumented;") : smarty_modifier_default($_tmp, "&notdocumented;")); ?>
...
$this->_sections['tree']['loop'] = is_array($_loop=$this->_tpl_vars['class_tree']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['mine']['loop'] = is_array($_loop=$this->_tpl_vars['class_tree'][$this->_sections['tree']['index']]) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_smarty_include(array('smarty_include_tpl_file' => "imethods.tpl", 'smarty_include_vars' => array('ivars' => $this->_tpl_vars['ivars'])));
