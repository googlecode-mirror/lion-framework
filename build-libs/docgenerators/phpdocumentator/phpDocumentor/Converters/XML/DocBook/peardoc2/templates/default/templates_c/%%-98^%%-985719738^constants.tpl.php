...
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'constants.tpl', 17, false),)), $this); ?>
...
$this->_sections['files']['loop'] = is_array($_loop=$this->_tpl_vars['defines']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['d']['loop'] = is_array($_loop=$this->_tpl_vars['defines'][$this->_sections['files']['index']]['defines']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<?php if ($this->_tpl_vars['defines'][$this->_sections['files']['index']]['defines'][$this->_sections['d']['index']]['conflicts']):  echo smarty_function_assign(array('var' => 'defineconflict','value' => true), $this); endif; ?>
<?php endfor; endif; ?>
